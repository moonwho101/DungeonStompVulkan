...
class VulkanSwapchainImageViews {
  ...
  public:
	...
	const VkImageView &operator[](int i) const {
...
class VulkanCommandBuffers {
  ...
  public:
	...
	const VkCommandBuffer &operator[](int i) const {
...
class VulkanUniformBuffer : public VulkanBuffer {
  ...
  public:
	...
	UniformBufferInfo operator[](int i) const {
		return bufferInfo[i];
	}
};
...
class VulkanVIBuffer : public VulkanBuffer {
  ...
  public:
	...
	operator size_t() const {
		return bufferLocations.size();
	}
	uint32_t operator[](int i) const {
		return bufferLocations[i];
	}
};
...
class VulkanImageList : public VulkanObject {
  ...
  public:
	...
	const Vulkan::Image &operator[](int n) const {
		return images[n];
	}
};
...
class VulkanTextureList : public VulkanObject {
  ...
  public:
	...
	const Vulkan::Texture &operator[](int i) const {
		return textures[i];
	}
};
...
class VulkanDescriptorList : public VulkanObject {
  ...
  public:
	...
	VkDescriptorSet operator[](int i) {
		return descriptorSetList[i];
	}
};
...
class VulkanFramebuffer : public VulkanObject {
  ...
  public:
	...
	~VulkanFramebuffer() {
		std::vector<VkFramebuffer> frameBuffers{ frameBuffer };
