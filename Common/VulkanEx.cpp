...
void DescriptorSetUpdater::setBindings() {
	...
	pLayout->getBindings(descriptorSetLayout, bindings);
...
PipelineBuilder::PipelineBuilder(VkDevice device_, VkPipelineLayout pipelineLayout_, VkRenderPass renderPass_, std::vector<Vulkan::ShaderModule> &shaders_, VkVertexInputBindingDescription &vertexInputDescription_, std::vector<VkVertexInputAttributeDescription> &vertexAttributeDescriptions_) : device(device_), pipelineLayout(pipelineLayout_), shaders(shaders_), renderPass(renderPass_), vertexInputDescription(vertexInputDescription_), vertexAttributeDescriptions(vertexAttributeDescriptions_) {
}
