...
BOOL CLoadWorld::LoadWorldMap(const char* filename)
{
	FILE* fp;
	char s[256];
	char p[256];
...
BOOL CLoadWorld::LoadObjectData(const char* filename)
{
	FILE* fp;
	int i;
	int done = 0;
...
BOOL CLoadWorld::LoadImportedModelList(const char* filename)
{
	FILE* fp;
	FILE* fp2;
	char p[256];
...
BOOL CLoadWorld::LoadMod(const char* filename)
{
	FILE* fp;
	char s[256];
	//	char p[256];
